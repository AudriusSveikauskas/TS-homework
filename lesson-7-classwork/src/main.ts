...
// Helpers
const printTask = (str: string) => console.log(`%c\n${str}\n`, 'color: #74c0fc; font-size: 12px');
const printTitle = (str: string) => console.log(`%c\n\t${str}\n`, 'color: #ffe066; font-size: 13px');
const printResult = <T>(data: T) => console.table(data);

printTask(
  `1. Dėklo (Stack) duomenų struktūros kūrimas.
...
printTask(
  `2. Eilės (Queue) duomenų struktūros kūrimas.
